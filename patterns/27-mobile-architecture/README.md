...
11 entries, 37,133 words. Every entry carries all 18
...
| [MVVM-C (Model-View-ViewModel-Coordinator)](mvvm-c.md) | canonical | 3,721 | Plain MVVM cleanly separates a screen's own presentation logic from its view, per Microsoft's own description, "the view model implements properties and commands to which the view ... |
