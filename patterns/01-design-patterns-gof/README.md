...
32 entries, 306,350 words, 1 more planned, 33 total when the family is complete. Every entry carries all 18
...
| [Role Object](role-object.md) | established | 8,695 | A single key abstraction is used from more than one context, and each context needs its own, different view of it. |
