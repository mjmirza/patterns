...
| [Pipeline Parallelism](pipeline-parallelism.md) | canonical | 7,243 | A program has to apply several distinct transformations to a large or unbounded stream of items, and the transformations are heterogeneous. |
...
| [Work Stealing](work-stealing.md) | canonical | 9,661 | A program decomposes into many small units of work, and the units are created dynamically during execution rather than known up front. |
